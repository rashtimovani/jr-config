...
public class TestFloatConverter {
	...
	public void testConvertingInvalidValues(final String valueFromResource) {
		new FloatConverter().convert(valueFromResource);
	}
	...
	@Test
	public void testConvertingValidValues(final String valueFromResource, final float value) {
		assertThat(new FloatConverter().convert(valueFromResource), equalTo(value));
	}

	@Test
	public void testEmptyValueConvertsToNull() {
		assertThat(new FloatConverter().convert(""), nullValue());
	}
	
	@Test
	public void testTrimmedValue() {
		assertThat(new FloatConverter().convert("   42.0 "), equalTo(42f));
	}
}
